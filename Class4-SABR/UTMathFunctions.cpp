...
double UTMathFunctions::normalDensity(double x)
{
	const double ONE_OVER_SQRT_TWO_PI = 0.398942280401433;

	return ONE_OVER_SQRT_TWO_PI*exp(-x*x / 2);
}

///////////////////////////////////////////////////////////////////////////////
// the InversecumulativeNormal function via the Beasley-Springer/Moro approximation
double UTMathFunctions::inverseCumulativeNormal(double u)
{
...
double UTMathFunctions::cumulativeNormal(double x)
{
